...
public class ActualizarAlojamiento extends javax.swing.JInternalFrame {
    ...
    private static final double PRECIO_HOTEL = 100000.00;
    private static final double PRECIO_HOSTEL = 90000.00;
    private static final double PRECIO_CABANA = 80000.00;
    private static final double PRECIO_DEPARTAMENTO = 95000.00;
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 750, 118));
    ...
    private void cargarImporteAlojamiento() {
        ...
        String tipoAlojamiento = (String) jcTAlojamiento.getSelectedItem();

        // Verificar si se seleccionó la opción por defecto
        if ("---Seleccionar---".equals(tipoAlojamiento)) {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione un tipo de alojamiento válido.");
            return; // Salir del método si no hay una selección válida
        }

        switch (tipoAlojamiento) {
            case "Hotel":
                precioAlojamiento = PRECIO_HOTEL;
                break;
            case "Hostel":
                precioAlojamiento = PRECIO_HOSTEL;
                break;
            case "Cabaña":
                precioAlojamiento = PRECIO_CABANA;
                break;
            case "Departamento":
                precioAlojamiento = PRECIO_DEPARTAMENTO;
                break;
            default:
                precioAlojamiento = 0;
                break;
        ...
        jtfImporte.setText(String.valueOf(precioAlojamiento));
    }
}
