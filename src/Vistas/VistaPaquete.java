...
public class VistaPaquete extends javax.swing.JInternalFrame {
    ...
    public VistaPaquete() {
        ...
        jCpaises.addActionListener(e -> habilitarProvincias());
        jCprovincias.addActionListener(e -> habilitarCiudades());
        jCciudades.addActionListener(e -> habilitarBotonBuscar());
        jTable1.getSelectionModel().addListSelectionListener(e -> habilitarBotonCargarImporte());
        jBcargarimporte.addActionListener(e -> habilitarCamposImporte());
        jCtransporte.addActionListener(e -> habilitarTuristas());
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 676, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
//        cargarCombociudad();
    ...
    private void aplicarDescuentoPorMenores() {
        ...
        double importeTransporte = 0;
        if (!jTimporteTransporte.getText().trim().isEmpty()) {
            try {
                importeTransporte = Double.parseDouble(jTimporteTransporte.getText());
            } catch (NumberFormatException e) {
                //JOptionPane.showMessageDialog(this, "El importe de transporte no es un número válido.");
                return;
            }
        } else {
            JOptionPane.showMessageDialog(this, "El importe de transporte no puede estar vacío.");
            return;
        }

        double importeAlojamiento = 0;
        if (!jtAlojamiento.getText().trim().isEmpty()) {
            try {
                importeAlojamiento = Double.parseDouble(jtAlojamiento.getText());
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "El importe de alojamiento no es un número válido.");
                return;
            }
        } else {
            //JOptionPane.showMessageDialog(this, "El importe de alojamiento no puede estar vacío.");
            return;
        }
    ...
    private void habilitarProvincias() {
        jCprovincias.setEnabled(true);
        cargarComboprovincias();
        deshabilitarCiudadesYBuscar();
    }

    private void habilitarCiudades() {
        jCciudades.setEnabled(true);
        cargarCombociudad();
    ...
    private void habilitarBotonBuscar() {
        if (jCciudades.getSelectedIndex() != -1) {
    ...
    private void habilitarBotonCargarImporte() {
        jBcargarimporte.setEnabled(jTable1.getSelectedRow() != -1);
    }

    private void deshabilitarCiudadesYBuscar() {
        jCciudades.setEnabled(false);
        jBbuscar.setEnabled(false);
    }

    private void habilitarTuristas() {
        jcbTurista1.setEnabled(true);
        jcbTurista2.setEnabled(true);
        jcbTurista3.setEnabled(true);
        jcbTurista4.setEnabled(true);
        jBagregar.setEnabled(true);
    }

    private void habilitarCamposImporte() {
        jtAlojamiento.setEnabled(true);
        jCtransporte.setEnabled(true);
        jTimporteTransporte.setEnabled(true);
        ImporteTotalPaquete.setEnabled(true);
        ImporteTotalPaquetemenores.setEnabled(true);
        ImporteTotal.setEnabled(true);
    }

    private void deshabilitarCampos() {

        jCprovincias.setEnabled(false);
        jCciudades.setEnabled(false);
        jBbuscar.setEnabled(false);
        jCtransporte.setEnabled(false);
        jBcargarimporte.setEnabled(false);
        jcbTurista1.setEnabled(false);
        jcbTurista2.setEnabled(false);
        jcbTurista3.setEnabled(false);
        jcbTurista4.setEnabled(false);
        jtAlojamiento.setEditable(false);
        jTimporteTransporte.setEnabled(false);
        ImporteTotal.setEnabled(false);
        ImporteTotalPaquete.setEnabled(false);
        ImporteTotalPaquetemenores.setEnabled(false);
        jtAlojamiento.setEnabled(false);
        jBagregar.setEnabled(false);
    }

    private void limpiarCamposYDeshabilitar() {

        jtAlojamiento.setText("");
        jTimporteTransporte.setText("0.0");
        ImporteTotal.setText("");
        ImporteTotalPaquete.setText("");
        ImporteTotalPaquetemenores.setText("");
